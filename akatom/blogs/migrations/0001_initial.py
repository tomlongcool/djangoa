    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('abstract', models.CharField(blank=True, default='本篇文章暂无摘要', max_length=255, null=True, verbose_name='文章摘要')),
                ...
                ('tags', taggit.managers.TaggableManager(help_text='多个标签用英文逗号(,)隔开!', through='taggit.TaggedItem', to='taggit.Tag', verbose_name='文章标签')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='articles', to=settings.AUTH_USER_MODEL, verbose_name='作者')),
            ],
            options={
                'verbose_name': '文章',
